...
class FooGatlingTest extends Simulation {
    ...
    val authorization_header = "Basic " + Base64.getEncoder.encodeToString("p04app:my-secret-token-to-change-in-production".getBytes(StandardCharsets.UTF_8))
    ...
    val scn = scenario("Test the Foo entity")
        ...
        .repeat(2) {
            ...
            .post("/api/foos")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "optionalString":"SAMPLE_TEXT", "requiredString":"SAMPLE_TEXT", "zonedDateTime":"2020-01-01T00:00:00.000Z", "logical":null, "blobField":null, "imageBlob":null, "enumField":null}""")).asJSON
            .check(status.is(201))
